menu = ['Главное меню','Открыть файл','Сохранить файл','Показать контакты','Создать контакт','Найти контакт','Изменить контакт','Удалить контакт','Выход']

input_menu = 'Выберите пункт меню:'

input_menu_error = f'Введите число от 1 до {len(menu)-1}'

load_succesfull = 'Телефонная книга загружена успешно!'
save_succesfull = 'Телефонная книга сохранена успешно!'
...
input_edit_contact = ['Введите имя нового контакта или ENTER, чтобы оставить без изменений: ' , 'Введите номер телефона или ENTER, чтобы оставить без изменений: ', 'Введите комментарий или ENTER, чтобы оставить без изменений: ']
